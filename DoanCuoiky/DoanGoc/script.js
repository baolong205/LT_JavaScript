...
function loginRequest(event) {
    ...
    // Kiểm tra xem tên người dùng có phải là 'admin' và mật khẩu có phải là '123456' hay không
...
function signUp() {
    ...
    if (firstName === '' || lastName === '' || email === '' || password === '') {
        ...
        return; // Dừng hàm nếu có trường nhập liệu rỗng
    }

    // Kiểm tra xác nhận mật khẩu (có thể thêm các điều kiện kiểm tra khác)

    // Gửi thông tin đăng ký đến máy chủ hoặc hệ thống lưu trữ phù hợp
    // Ở đây bạn có thể sử dụng AJAX để gửi yêu cầu đến máy chủ hoặc thực hiện các hành động lưu trữ phù hợp khác

    // Hiển thị thông báo xác nhận
    alert('Đăng ký thành công!');

    // Hiển thị lựa chọn để đăng nhập ngay lập tức
    var signInButton = document.getElementById('signInButton');
    signInButton.style.backgroundColor = '#007bff'; // Thay đổi màu nút Sign In thành màu xanh
    signInButton.click(); // Tự động kích hoạt sự kiện click trên nút Sign In để mở form đăng nhập
}
